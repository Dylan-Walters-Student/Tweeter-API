...
namespace TweeterAPI.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        {
            string commandText = $"UPDATE Accounts SET account_name = @account_name, account_password = @account_password, account_email = @account_email, account_biography = @account_biography WHERE account_id = @account_id";
